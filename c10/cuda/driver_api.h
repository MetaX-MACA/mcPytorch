...
// PyTorch.
  ...
  #define C10_LIBCUDA_DRIVER_API_REQUIRED(_)                                    \
    _(cuDeviceGetAttribute, wcuDeviceGetAttribute)                     \   
    ...
    _(cuMemGetAllocationGranularity, wcuMemGetAllocationGranularity)   \
    _(cuMemExportToShareableHandle, wcuMemExportToShareableHandle)     \
    _(cuMemImportFromShareableHandle, wcuMemImportFromShareableHandle) \
    _(cuMemsetD32Async, wcuMemsetD32Async)                             \
    _(cuStreamWriteValue32, wcuStreamWriteValue32)                     \
...
#define C10_NVML_DRIVER_API(_)                                                      \
  ...
  _(nvmlSystemGetCudaDriverVersion_v2, mxSmlExSystemGetDriverVersion)
...
#define CREATE_MEMBER(name,name1) decltype(&name1) name##_;
  C10_LIBCUDA_DRIVER_API_REQUIRED(CREATE_MEMBER)
