...
#if defined(PYTORCH_C10_DRIVER_API_SUPPORTED) && !defined(USE_MACA) // TODO(): USE_MACA
...
#ifdef USE_MACA
      if (C10_UNLIKELY(c10::cuda::CUDACachingAllocator::
                           get_maca_graph_mem_policy_default())) {
#endif
...
constexpr int small_memcpy_size = 256;
constexpr int reduceAsyncMemcpySrc[small_memcpy_size] = {0};
int getSmallMemcpyByteSize() {
  return small_memcpy_size * sizeof(int);
}
