...
#if !defined(__clang__) && !defined(_MSC_VER) && defined(__GNUC__) && !defined(USE_MACA) && \
    __GNUC__ < 9
#error \
...
#if defined(__cpp_lib_apply) && !defined(__CUDA_ARCH__) && !defined(__HIP__) && !defined(USE_MACA)
