...
# USE_MACA: sdpa cannot be symbolized, skip fake tensor mode test
fake_autocast_device_skips["cuda"] = {"linalg.pinv", "pinverse", "nn.functional.scaled_dot_product_attention"}
