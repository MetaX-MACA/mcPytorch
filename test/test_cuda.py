...
class TestCuda(TestCase):
    ...
    #(TODO MACA) different implemention on memory allocate?
...
""",
    ...
    # (TODO MACA) distribution_elementwise_grid_stride_kernel_opt bug, to be fixed by chunyou)
    # @unittest.skipIf(not TEST_LARGE_TENSOR, "not enough memory")
    # @gcIfJetson
    # @serialTest()
...
"""
    ...
    #(TODO MACA) LSTM should not use cudaMalloc when capture graph
    # @skipIfRocm
    # @unittest.skipIf(
    #     not TEST_CUDA_GRAPH, "CUDA >= 11.0 or ROCM >= 5.3 required for graphs"
    # )
    ...
    # (TODO MACA) driver implemention is different with cuda?
    # @unittest.skipIf(
    #     not TEST_CUDA_GRAPH, "CUDA >= 11.0 or ROCM >= 5.3 required for graphs"
    # )
...
class TestCudaMallocAsync(TestCase):
    # (todo bxiong) skip because this test need urlib to access from network
    # @unittest.skipIf(
    ...
    #(todo bxiong) pynvml not supported now
    '''
