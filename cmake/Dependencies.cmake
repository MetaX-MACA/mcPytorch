...
# ---[ cuDNN
if(USE_CUDNN)
  message(STATUS "Found CUDNN_VERSION: ${CUDNN_VERSION}.")
  # TODO(bxiong) skip CUDNN_VERSION check to avoid incremental compilation error
  if(NOT USE_MACA AND CUDNN_VERSION VERSION_LESS 8.5)
...
if(USE_GLOO)
  if(NOT CMAKE_SIZEOF_VOID_P EQUAL 8)
    ...
    if(NOT USE_SYSTEM_GLOO)
      ...
      if(USE_MACA)
        set(GLOO_USE_CUDA_TOOLKIT OFF CACHE BOOL "" FORCE)
      else()
