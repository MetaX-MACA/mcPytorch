...
function(caffe2_print_configuration_summary)
  ...
  message(STATUS "  USE_MACA              : ${USE_MACA}")
  if(${USE_MACA})
    message(STATUS "    MACA_VERSION        : ${MACA_VERSION}")
    message(STATUS "    USE_NO_BLAS_BACKEND : ${USE_NO_BLAS_BACKEND}")
  endif()
  message(STATUS "  MACA_BUILD_MONOLITHIC_TORCH_CUDA_LIB         : ${MACA_BUILD_MONOLITHIC_TORCH_CUDA_LIB}")
