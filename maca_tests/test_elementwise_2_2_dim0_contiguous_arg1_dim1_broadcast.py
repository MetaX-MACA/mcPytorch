...
def test_masked_fill():
    shape_list = [(65526,128),(512, 80), (111, 168), (22, 124), (13, 128)]
    stride_list= [(1,    0)  ,(2,    0), (3,   0),   (180,  0), (64, 0  )]
...
def test_2_2_dim0_contiguous_arg1_dim1_broadcast():
    shape_list =   [(64, 80), (64, 80), (68, 128), (96, 100), (100, 100)]
    stride0_list = [(80, 1),  (240,1),  (256,1),   (200,1),   (400,1)]
    stride1_list = [(80, 0),  (80, 0),  (128,0),   (100, 0),  (100,0)]
...
test_masked_fill()
test_2_2_dim0_contiguous_arg1_dim1_broadcast()
