...
if __name__ == "__main__":
    ...
    yaml_cfg_parser.add_argument("--enable_profiler", default=False, action="store_true")
    yaml_cfg_parser.add_argument("--enable_perf", default=False, action="store_true")
    ...
    main(args, model_args, model_arch, yaml_args.enable_profiler, yaml_args.enable_perf)
