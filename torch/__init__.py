...
if not os.getenv("KMP_INIT_AT_FORK", None):
...
# USE_MACA
disable_flash_attn = builtins.int(os.getenv("DISABLE_PYTORCH_USE_FLASHATTN", '0'))
disable_amp_flash_attn = builtins.int(os.getenv("DISABLE_AMP_FLASHATTN", '0'))
if not disable_flash_attn:
    try:
        ...
        import warnings
        warnings.warn(f"Could not find flash_attn package installed. Please try to install flash_attn whl pacakge using pip command and make sure it can be imported properly", stacklevel=2)
