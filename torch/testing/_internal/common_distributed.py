...
if TEST_WITH_TSAN:
    ...
    #todo(bincheng.xiong) when run on cmodel, the TIMEOUT_DEFAULT is set as 10000, which was 300 on chips.
    TIMEOUT_DEFAULT = int(os.getenv('DISTRIBUTED_TESTS_DEFAULT_TIMEOUT', '10000'))
