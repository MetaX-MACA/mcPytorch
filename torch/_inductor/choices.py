...
import torch._inductor.config as cfg # USE_MACA
...
class InductorChoices:
    ...
    def should_use_persistent_reduction(
        ...
        # USE_MACA: When the switch is enabled, it adjusts the admission threshold for persistent mode (4096),
        # typically used in standalone mode.
        if cfg.maca.reduce_persistent_threshold:
            threshold *= cfg.maca.pesistent_threshold_scale
