...
# USE_MACA TODO()
# as cubridge cannot handle precompile command, we disable this function tmp
# cpp_cache_precompile_headers: bool = not is_fbcode()
cpp_cache_precompile_headers = False # USE_MACA
...
# USE_MACA disable device_assert as maca triton not support currently
assert_indirect_indexing = True if not USE_MACA else False
...
class aot_inductor:
    ...
    precompile_headers: bool = False # USE_MACA
...
if USE_MACA:
    # flush general configs after maca update
    from torch._inductor.config_maca import *
    torch._inductor.config_maca._updateConfigs(globals())
