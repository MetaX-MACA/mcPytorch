...
from ..maca.triton_heuristics import (
    maca_persistent,
    maca_reduction,
    maca_pointwise,
)
                ...
                triton_config(
                    ...
                    *xyz,
                    num_elements_per_warp=(
                        ...
                        else (32 if not USE_MACA else 64)
                    ),
                )
...
class CachingAutotuner(KernelInterface):
    ...
    def _dynamic_scale_rblock(self):
        ...
        if (
            ...
            warp_size = device_prop.warp_size or 32 if not USE_MACA else 64
            for result in self.compile_results:
    ...
    def get_device_interface(self):
        ...
        return get_interface_for_device(
            self.device_props.type.replace("hip", "cuda").replace("maca", "cuda")
        )
    ...
    def save_gpu_kernel(self, stream, launcher):
        ...
        # USE_MACA
        bin_type = {"hip": "hsaco", "xpu": "spv", "maca": "mcfatbin"}.get(
...
def _check_max_grid_x(size_hints, x, num_warps):
    ...
    warp_size = (
        64 if (torch.version.hip or USE_MACA) else 32
