...
#ifdef USE_MACA
TORCH_CUDA_CPP_API void all2all_single_equal_split_sdma(
    at::Tensor& input,
    at::Tensor& output,
    int size,
    ncclComm_t comm,
...
#ifdef USE_MACA
TORCH_CUDA_CPP_API void all2all_single_unequal_split_sdma(
    void* sendbuff,
    const size_t* sendcounts,
    const size_t* senddispls,
    void* recvbuff,
...
#ifdef USE_MACA
TORCH_CUDA_CPP_API void send_ext(
    const at::Tensor& input,
    ncclComm_t comm,
    at::cuda::CUDAStream stream,
    int dst);

TORCH_CUDA_CPP_API void recv_ext(
    at::Tensor& output,
    ncclComm_t comm,
    at::cuda::CUDAStream stream,
    int src);
