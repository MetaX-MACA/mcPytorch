...
communication mechanism.
  ...
  auto processGroup =
      intrusive_ptr_no_gil_destructor_trampoline_class_<
          ...
          .def(
              "allreduce_sdma",
              &::c10d::ProcessGroup::allreduce_sdma,
              py::arg("tensors"),
              py::arg("opts") = ::c10d::AllreduceOptions(),
              py::call_guard<py::gil_scoped_release>(),
              R"(Allreduces the provided tensors across all processes in the process group.
...
#ifdef USE_MACA
          .def(
              "allreduce_coalesced_sdma",
              &::c10d::ProcessGroup::allreduce_coalesced_sdma,
              py::arg("tensors"),
              py::arg("opts") = ::c10d::AllreduceCoalescedOptions(),
              py::call_guard<py::gil_scoped_release>(),
              R"(Allreduces the provided tensors across all processes in the process group.
...
#ifdef USE_MACA
          .def(
              "_allgather_base_sdma",
              &::c10d::ProcessGroup::_allgather_base_sdma,
              py::arg("output"),
              py::arg("input"),
              py::arg("opts") = ::c10d::AllgatherOptions(),
              py::call_guard<py::gil_scoped_release>())
...
#ifdef USE_MACA
          .def(
              "allgather_into_tensor_coalesced_sdma",
              &::c10d::ProcessGroup::allgather_into_tensor_coalesced_sdma,
              py::arg("outputs"),
              py::arg("inputs"),
              py::arg("opts") = ::c10d::AllgatherOptions(),
              py::call_guard<py::gil_scoped_release>(),
          ...
          .def(
              ...
              &::c10d::ProcessGroup::_reduce_scatter_base_sdma,
              py::arg("outputTensor"),
              py::arg("inputTensor"),
              py::arg("opts") = ::c10d::ReduceScatterOptions(),
              py::call_guard<py::gil_scoped_release>())
          ...
          .def(
              ...
              &::c10d::ProcessGroup::reduce_scatter_tensor_coalesced_sdma,
              py::arg("outputs"),
              py::arg("inputs"),
              py::arg("opts") = ::c10d::ReduceScatterOptions(),
              py::call_guard<py::gil_scoped_release>(),
          ...
          .def(
              "alltoall_base_sdma",
              &::c10d::ProcessGroup::alltoall_base_sdma,
              py::arg("output"),
              py::arg("input"),
              py::arg("output_split_sizes"),
              py::arg("input_split_sizes"),
