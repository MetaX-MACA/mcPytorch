...
#if defined(USE_ROCM) || (defined(CUDART_VERSION) && CUDART_VERSION >= 12030) || defined(USE_MACA)
...
#if !(defined(USE_ROCM) || defined(USE_MACA)) //No multi-cast support on ROCm yet
...
#endif
#if defined(CUDART_VERSION) && !defined(USE_MACA)
