...
#ifdef USE_MACA
 virtual c10::intrusive_ptr<Work> allreduce_sdma(
      std::vector<at::Tensor>& /* tensors */,
      const AllreduceOptions& /* opts */ = AllreduceOptions()) {
    TORCH_CHECK(
        false,
        c10::str("Backend ", getBackendName(), " does not support allreduce_sdma"));
  }
#endif
...
#ifdef USE_MACA
  virtual c10::intrusive_ptr<Work> allreduce_coalesced_sdma(
      std::vector<at::Tensor>& /* tensors */,
      const AllreduceCoalescedOptions& /* opts */ =
          AllreduceCoalescedOptions()) {
    TORCH_CHECK(
        ...
        c10::str(
            "Backend ",
            getBackendName(),
            " does not support allreduce_coalesced_sdma"));
  }
#endif
...
#ifdef USE_MACA
  virtual c10::intrusive_ptr<Work> _allgather_base_sdma(
      at::Tensor& /* outputBuffer */,
      at::Tensor& /* inputBuffer */,
      const AllgatherOptions& /* opts */ = AllgatherOptions()) {
    TORCH_CHECK(
        false,
        c10::str(
            "Backend ", getBackendName(), " does not support _allgather_base_sdma"));
  }
#endif
...
#ifdef USE_MACA
  virtual c10::intrusive_ptr<Work> allgather_into_tensor_coalesced_sdma(
      std::vector<at::Tensor>& /* outputs */,
      std::vector<at::Tensor>& /* inputs */,
      const AllgatherOptions& /* opts */ = AllgatherOptions()) {
    TORCH_CHECK(
        ...
        c10::str(
            "Backend ",
            getBackendName(),
            " does not support allgather_into_tensor_coalesced_sdma"));
  }
#endif
...
#ifdef USE_MACA
  virtual c10::intrusive_ptr<Work> _reduce_scatter_base_sdma(
      at::Tensor& /* outputBuffer */,
      at::Tensor& /* inputBuffer */,
      const ReduceScatterOptions& /* opts */ = ReduceScatterOptions()) {
    TORCH_CHECK(
        ...
        c10::str(
            "Backend ",
            getBackendName(),
            " does not support _reduce_scatter_base_sdma"));
  }
#endif
...
#ifdef USE_MACA
  virtual c10::intrusive_ptr<Work> reduce_scatter_tensor_coalesced_sdma(
      std::vector<at::Tensor>& /* outputs */,
      std::vector<at::Tensor>& /* inputs */,
      const ReduceScatterOptions& /* opts */ = ReduceScatterOptions()) {
    TORCH_CHECK(
...
#ifdef USE_MACA
  virtual c10::intrusive_ptr<Work> alltoall_base_sdma(
      at::Tensor& /* outputBuffer */,
      at::Tensor& /* inputBuffer */,
      std::vector<int64_t>& /* outputSplitSizes */,
      std::vector<int64_t>& /* inputSplitSizes */,
    ...
    TORCH_CHECK(
        false,
        c10::str(
            "Backend ", getBackendName(), " does not support alltoall_base_sdma"));
  }
#endif
...
#ifdef USE_MACA
  virtual c10::intrusive_ptr<Work> send_ext(
      std::vector<at::Tensor>& /* tensors */,
      int /* dstRank */,
      int /* tag */) {
    TORCH_CHECK(
        false,
        c10::str("Backend ", getBackendName(), " does not support send_ext"));
  }
#endif
...
#ifdef USE_MACA
virtual c10::intrusive_ptr<Work> recv_ext(
      std::vector<at::Tensor>& /* tensors */,
      int /* srcRank */,
      int /* tag */) {
    TORCH_CHECK(
        false,
        c10::str("Backend ", getBackendName(), " does not support recv_ext"));
  }
#endif
