...
from torch._utils_internal import justknobs_check, USE_MACA
        ...
        for key, value in list(source.__dict__.items()):
            ...
            if isinstance(value, CONFIG_TYPES):
                ...
                if not USE_MACA:
                    ...
                    # USE_MACA: class maca is belong to torch._inductor.maca_config not torch._inductor.config
                    assert (value.__module__ == module.__name__ or value.__name__ == 'maca')
