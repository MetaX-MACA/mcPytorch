...
def main():
    ...
    torch_package_data = [
        ...
        'include/ATen/native/cuda/maca_kernels/*.h',
        'include/ATen/native/cuda/maca_kernels/*.cuh',
        ...
        'share/sample/bert/configs/*.*',
        'share/sample/bert/*.*',
        'share/sample/amp/*.*',
        'share/sample/amp/data/*.*',
        'share/sample/resnet50/configs/*.*',
        'share/sample/resnet50/*.*',
        'share/sample/dlrm/configs/*.*',
        'share/sample/dlrm/*.*',
        'share/sample/yolov5/*.*',
        'share/sample/yolov5/hyps/*.*',
        'share/sample/yolov5/models/*.*',
        'share/sample/yolov5/utils/*.*',
        'share/sample/bert_ddp/*.*',
        'share/sample/libtorch_demo/*.*',
        'share/sample/cpp_extension_cuda_demo/*.*',
        'share/sample/cpp_extension_cuda_demo/mypackage/*.*'
    ]
    ...
    setup(
        ...
        package_data={
            ...
            'maca_tools': macatools_package_data,
            'caffe2': [
                'python/serialized_test/data/operator_test/*.zip',
            ],
        },
        author='Metax PyTorch Team',
        author_email='',
