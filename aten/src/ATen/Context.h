...
//TODO: disable it by default as mcdnn tf32 precision lower than cudnn
#ifdef USE_MACA
  bool allow_tf32_cudnn = maca_unlikely(at::maca::get_maca_disable_cuda_cudnn_tf32()) ? false : true;
#else
  static_assert(0);
...
#ifdef USE_MACA
      {{Float32Backend::CUDA, Float32Op::CONV}, allow_tf32_cudnn ? Float32Precision::TF32 : Float32Precision::NONE},
      {{Float32Backend::CUDA, Float32Op::RNN}, allow_tf32_cudnn ? Float32Precision::TF32 : Float32Precision::NONE},
#else
