...
size_t parseChosenWorkspaceSize() {
  ...
  const bool disable_default_32m = at::maca::get_maca_disable_blas_workspace_default_32m();
  const bool force_32m = at::maca::get_maca_force_blas_workspace_32m();
  const size_t default_size = (force_32m) ? 4096 * 8 * 1024 : ((!disable_default_32m) ? 4096 * 16 * 1024 : 4096 * 1024 * 2 + 16 * 1024 * 8);
#else
...
#elif defined(USE_MACA)
  size_t workspace_size = 64*1024; /* Use 64 MB for mcBLASLt */
#else
