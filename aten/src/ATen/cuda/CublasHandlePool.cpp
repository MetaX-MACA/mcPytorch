...
size_t parseChosenWorkspaceSize() {
  ...
  bool disable_default_32m = at::maca::get_maca_disable_blas_workspace_default_32m();
  const size_t default_size = (sm90 || !disable_default_32m) ? 4096 * 8 * 1024 : 4096 * 1024 * 2 + 16 * 1024 * 8;
