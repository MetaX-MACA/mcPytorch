...
#ifdef USE_MACA
// TODO(): remove this when alignment problem is fixed
namespace {
#include <assert.h>
template<class T>
bool mcpytorch_is_int2() { return false; }
template<>
bool mcpytorch_is_int2<int2>() { return true; }
}
#endif
