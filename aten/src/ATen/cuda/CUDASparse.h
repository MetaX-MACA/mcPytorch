...
// USE_MACA: CUSPARSE_VERSION is 11500 in maca platform. Here add USE_MACA to enable AT_USE_CUSPARSE_GENERIC_SPSM.
#if (defined(CUDART_VERSION) && defined(CUSPARSE_VERSION) && (CUSPARSE_VERSION >= 11600)) || defined(USE_MACA)
