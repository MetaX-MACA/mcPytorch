...
#define AT_DISPATCH_FLOATING_TYPES_AND2_DOUBLE_SPECIAL(       \
    SCALARTYPE1, SCALARTYPE2, TYPE, NAME, NORMAL_FUNC, DOUBLE_FUNC) \
  AT_DISPATCH_SWITCH(                          \
      TYPE,                                    \
      NAME,                                    \
      AT_DISPATCH_CASE(at::ScalarType::Float, NORMAL_FUNC)   \
      AT_DISPATCH_CASE(at::ScalarType::Double, DOUBLE_FUNC)   \
      AT_DISPATCH_CASE(SCALARTYPE1, NORMAL_FUNC)             \
      AT_DISPATCH_CASE(SCALARTYPE2, NORMAL_FUNC))
...
#define AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2_FLOAT_AND_HALF_SPECIAL(    \
    SCALARTYPE1, SCALARTYPE2, TYPE, NAME, OPT_FUNC, NORMAL_FUNC)          \
  AT_DISPATCH_SWITCH(                                   \
      TYPE,                                             \
      NAME,                                             \
      AT_DISPATCH_CASE(at::ScalarType::ComplexDouble, NORMAL_FUNC) \
      AT_DISPATCH_CASE(at::ScalarType::ComplexFloat, NORMAL_FUNC) \
      AT_DISPATCH_CASE(at::ScalarType::Float, OPT_FUNC)   \
      AT_DISPATCH_CASE(at::ScalarType::Double, NORMAL_FUNC)   \
      AT_DISPATCH_CASE(SCALARTYPE1, OPT_FUNC)             \
      AT_DISPATCH_CASE(SCALARTYPE2, OPT_FUNC))
...
#define AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND4_OPT_TYPE(                                   \
    SCALARTYPE1, SCALARTYPE2, SCALARTYPE3, SCALARTYPE4, TYPE, NAME, NORMAL_FUNC, OPT_FUNC) \
    AT_DISPATCH_SWITCH(                                                                    \
      TYPE,                                                                                \
      NAME,                                                                                \
      AT_DISPATCH_CASE(SCALARTYPE1, NORMAL_FUNC)                                           \
      AT_DISPATCH_CASE(SCALARTYPE2, OPT_FUNC)                                              \
      AT_DISPATCH_CASE(SCALARTYPE3, OPT_FUNC)                                              \
      AT_DISPATCH_CASE(SCALARTYPE4, NORMAL_FUNC)                                           \
      AT_DISPATCH_CASE_COMPLEX_TYPES(NORMAL_FUNC)                                          \
      AT_DISPATCH_CASE_INTEGRAL_TYPES(NORMAL_FUNC)                                         \
      AT_DISPATCH_CASE(at::ScalarType::Double, NORMAL_FUNC)                                \
      AT_DISPATCH_CASE(at::ScalarType::Float, OPT_FUNC))
