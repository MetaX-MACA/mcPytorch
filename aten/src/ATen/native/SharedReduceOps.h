...
struct MinMaxReductionOps {
  ...
  static C10_DEVICE void reduce_no_struct(scalar_t arg_val, int64_t arg_idx, scalar_t val, int64_t idx, scalar_t *result_val, int64_t *result_idx) {
    if (comp_t{}(arg_val, val, arg_idx, idx)) {
      *result_val = arg_val;
      *result_idx = arg_idx;
    } else {
      *result_val = val;
  ...
  static C10_DEVICE void combine_no_struct(scalar_t arg_val, int64_t arg_idx, scalar_t val, int64_t idx, scalar_t *result_val, int64_t *result_idx) {
    if (comp_t{}(arg_val, val, arg_idx, idx)) {
      *result_val = arg_val;
      *result_idx = arg_idx;
    } else {
  ...
  static C10_DEVICE void warp_shfl_down_no_struct(scalar_t arg_val, int64_t arg_idx, scalar_t *other_val, int64_t *other_idx, int offset) {
    *other_val = WARP_SHFL_DOWN(arg_val, offset);
    *other_idx = WARP_SHFL_DOWN(arg_idx, offset);
  }
#endif
};
...
struct MinMaxOps {
  ...
  inline C10_DEVICE void reduce_no_struct(scalar_t arg_val, int64_t arg_idx, scalar_t val, int64_t idx, scalar_t *result_val, int64_t *result_idx) {
    assert(false); // no struct will never be run into this op currently.
  }
  ...
  inline C10_DEVICE void combine_no_struct(scalar_t arg_val, int64_t arg_idx, scalar_t val, int64_t idx, scalar_t *result_val, int64_t *result_idx) {
    assert(false); // no struct will never be run into this op currently.
  }
  ...
  inline C10_DEVICE void warp_shfl_down_no_struct(scalar_t arg_val, int64_t arg_idx, scalar_t *other_val, int64_t *other_idx, int offset) {
    assert(false); // no struct will never be run into this op currently.
  }
#endif
};
