...
#if defined(USE_MACA)
Tensor cudnn_convolution_bias_fused(
  ...
  CheckedFrom c = "cudnn_convolution_bias_fused";
  ...
  Tensor z = at::detail::empty_cuda(
         output_t.sizes(), input->options().memory_format(memory_format));
  ...
  raw_cudnn_convolution_bias_fused_out(
      *output, input_contig, weight_contig, z, bias_t,
