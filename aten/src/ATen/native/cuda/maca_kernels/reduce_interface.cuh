...
static ReduceKernelType get_reduce_kernel_type(const TensorIterator& iter, bool is_not_over_i32_scope) {
  ...
  if(maca_likely(!at::maca::get_maca_disable_continuous_reduce_transpose_kernel()) && is_ndim_3_reduce_dims_1_transpose_all_continuous_case(iter, sizeof(scalar_t), sizeof(out_scalar_t))){
