    ...
    if(!equal){
      if (blockIdx.x != gridDim.x-1 && blockIdx.y != gridDim.y-1){
        ...
        for ( int i=0;i<8;i++)
        {
          ...
          *out = f(func_reinterpret_cast<arg0_t>(data1 + offset),data_s[intro_g_id][8*i+inter_g_id]);
        }
      } else {
        #pragma unroll
        for ( int i=0;i<8;i++)
      ...
      if (blockIdx.x != gridDim.x-1 && blockIdx.y != gridDim.y-1){
        ...
        for ( int i=0;i<8;i++)
        {
          ...
          stride_t offset=offsets_start1+(8*i+inter_g_id)*stridea1+intro_g_id*stride01;
          res_t* out = (res_t*)(data0 + offsets0);
          *out = f(func_reinterpret_cast<arg0_t>(data1 + offset),data_s[8*i+inter_g_id][intro_g_id]);
        }
      } else {
        #pragma unroll
        for ( int i=0;i<8;i++)
...
static void launch_legacy_kernel_maca_3_2(
  ...
  if(maca_unlikely(env)){
    ...
    bool disable_opt_tile =
          (size0 == 1920 && size1 == 5 && size2 == 2048 && sizeof(res_t) == 2 &&
          stride00 == sizeof(res_t) && stride10 == size0 * stride00 && stride20 == size1 * stride10 &&
          stride01 == stride00 && stride11 == stride10 && stride21 == stride20 &&
          stride02 == sizeof(res_t) && stride12 == size2 * stride22 && stride22 == size0 * stride02) ||
          (sizeof(res_t) == 4 && size0 == 60416 && size1 == 5 && size2 == 1024 &&
          stride00 == sizeof(res_t) && stride10 == size0 * stride00 && stride20 == size1 * stride10 &&
          stride01 == stride00 && stride11 == stride10 && stride21 == stride20 &&
          stride02 == 0 && stride22 == sizeof(arg1_t) && stride12 == 2 * size2 * stride22);
    if(maca_likely(!at::maca::get_maca_disable_element_kernel_opt_tile()) && (!disable_opt_tile)){
      ...
      if(*min_stride_arg0<=40 && *min_stride_arg1<=40 && *min_stride_arg2<=40 && (size0*size1*size2>64*64*64))
      {
        ...
        }else if(dim_with_minimum_stride_arg0==0 && dim_with_minimum_stride_arg1==0 && dim_with_minimum_stride_arg2==0){//000
          dim3 grid ( ceilf((float)size0/(float)64),ceilf((float)(size1)/(float)64) ,size2);
          dim3 block (512)  ;
...
void gpu_kernel_impl_maca_arity2(TensorIteratorBase& iter, const func_t& f) {
  ...
  if (!dynamic_casting) {
      ...
      launch_vectorized_kernel(numel, f, data);
        ...
        if (ndim == 1) {
          ...
          if(((sizeof(arg0_t) == 2 && sizeof(arg1_t) == 2 && sizeof(arg2_t) == 2) || (sizeof(arg0_t) == 4 && sizeof(arg1_t) == 4 && sizeof(arg2_t) == 4)) && 
            ...
            get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_1_2_broadcast", f);
            ...
            get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_1_2", f);
          ...
          at::detail::Array<ScalarType, 3> dtypes;
          for (int i = 0; i < 3; i++) {
          ...
          if(((sizeof(arg0_t) == 2 && sizeof(arg1_t) == 2 && sizeof(arg2_t) == 2) || (sizeof(arg0_t) == 4 && sizeof(arg1_t) == 4 && sizeof(arg2_t) == 4)) &&
            ...
            get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_2_2_align", f);
            ...
            get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_2_2_broadcast", f);
            ...
            get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_2_2_interval", f);
            ...
            if (maca_likely(!disable_2_2_template) && ((sizeof(arg0_t) == 2 && sizeof(arg1_t) == 2 && sizeof(arg2_t) == 2) ||
              ...
              get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_2_2_template", f);
              ...
              get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_2_2", f);
          ...
          if (((sizeof(arg0_t) == 2 && sizeof(arg1_t) == 2 && sizeof(arg2_t) == 2) ||
              ...
              get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_3_2_arity2_transpose", f);
              ...
              get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_3_2_arity2_transpose_dim02", f);
            ...
            if (((sizeof(arg0_t) == 2 && sizeof(arg1_t) == 2 && sizeof(arg2_t) == 2) || (sizeof(arg0_t) == 4 && sizeof(arg1_t) == 4 && sizeof(arg2_t) == 4)) &&
                ...
                get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_3_2_broadcast_dim2_arg0_contiguous", f);
                ...
                get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_3_2_broadcast_dim1_contiguous", f);
                ...
                offset_calc.strides_[2][2] % (s0 * sizeof(arg0_t)) == 0 && s0 * s2 >= C10_WARP_SIZE && (s0 & (s0 -1)) == 0 && s0 <= C10_WARP_SIZE) {
                  get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_3_2_broadcast_dim1_contiguous_s", f);
                ...
                offset_calc.strides_[1][2] % (s0 * sizeof(arg0_t)) == 0 && s0 * s1 >= C10_WARP_SIZE && (s0 & (s0 -1)) == 0 && s0 <= C10_WARP_SIZE) {
                  get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_3_2_broadcast_dim2_contiguous_s", f);
              ...
              get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_3_2_broadcast_dim1_uncontiguous", f);
              launch_legacy_kernel_maca_3_2_broadcast_dim1_uncontiguous<128, unroll_factor, arg0_t, typename traits::template arg<0>::type, typename traits::template arg<1>::type>(
                ...
                // TODO(): support s0 < WARP_SIZE as 3_2_broadcast_dim1_uncontiguous kernel
                // TODO(): check if support offset_calc.strides_[1][2] > 0 but not only offset_calc.strides_[1][2] % (s0 * sizeof(arg0_t)) == 0
                get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_3_2_broadcast_dim2_contiguous", f);
              ...
              get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_3_2_broadcast_dim2_uncontiguous", f);
              ...
              get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_3_2", f);
          ...
          (reinterpret_cast<uintptr_t>(data[2]) % 4) == 0) {
            get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_4_2_opt", f);
            ...
            get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_4_2_uncontiguous", f);
            launch_legacy_kernel_maca_4_2_uncontiguous<128, unroll_factor, arg0_t, typename traits::template arg<0>::type, typename traits::template arg<1>::type>(
                ...
                (reinterpret_cast<uintptr_t>(data[2]) % 4) == 0) {
            get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_4_2_template", f);
            ...
            get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_4_2", f);
    ...
    if (contiguous) {
      ...
      assert(narity == 2);
      if (ndim == 1) {
        get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_1_2_cast", f);
        ...
        if (((dtypes[0] == ScalarType::Float && dtypes[1] == ScalarType::Half && dtypes[2] == ScalarType::Float &&
            ...
            s0 >= C10_WARP_SIZE && maca_likely(!disable_opt)){ // float, float16, bfloat16
              ...
              // partial memory write and alignment fault.
              // 8 * C10_WARP_SIZE to be considered as best block size.
          get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_2_2_cast_broadcast", f);
          ...
          get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_2_2_cast_template", f);
          ...
          get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_2_2_cast", f);
        ...
        get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_3_2_cast", f);
        size_t s0 = offset_calc.sizes_[0].divisor;
        ...
        if (dtypes[0] == ScalarType::Float && dtypes[1] == ScalarType::Half && dtypes[2] == ScalarType::Float &&
         ...
         if (dtypes[0] == ScalarType::Float && dtypes[1] == ScalarType::Float &&
            ...
            get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_4_2_cast_broadcast", f);
            ...
            get_elementwise_info<narity + 1>(ndim, narity, offset_calc, "p_e_launch_legacy_kernel_maca_4_2_cast", f);
