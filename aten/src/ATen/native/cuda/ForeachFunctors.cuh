...
template<typename T, int depth, int r_args_depth, int res_arg_index>
struct BinaryOpScalarFunctorOpt {
    using opmath_t = at::opmath_type<T>;
    template<typename Op> __device__ __forceinline__ void operator() (
        int chunk_size,
        TensorListMetadata<depth> *tl,
...
template<typename T, int depth, int r_args_depth, int res_arg_index>
struct BinaryOpScalarListFunctorOpt {
    using opmath_t = at::opmath_type<T>;
    template<typename Op> __device__ __forceinline__ void operator() (
        int chunk_size,
        TensorListScalarListMetadata<opmath_t, depth> *tl,
...
template<typename T, int depth, int r_args_depth, int res_arg_index>
struct BinaryOpListAlphaFunctorOpt {
    using opmath_t = at::opmath_type<T>;
    template<typename Op> __device__ __forceinline__ void operator() (
        int chunk_size,
        TensorListMetadata<depth>* tl,
...
template<typename T, int depth, int r_args_depth, int res_arg_index>
struct PointwiseOpScalarFunctorOpt {
    using opmath_t = at::opmath_type<T>;
    template<typename Op> __device__ __forceinline__ void operator() (
        int chunk_size,
        TensorListMetadata<depth>* tl,
...
template<typename T, int depth, int r_args_depth, int res_arg_index>
struct PointwiseOpScalarListFunctorOpt {
    using opmath_t = at::opmath_type<T>;
    template<typename Op> __device__ __forceinline__ void operator() (
        int chunk_size,
        TensorListScalarListMetadata<opmath_t, depth>* tl,
...
template<typename T, int depth, int r_args_depth, int res_arg_index>
struct TernaryOpListFunctorOpt {
  using opmath_t = at::opmath_type<T>;
  template<typename Op> __device__ __forceinline__ void operator() (
      int chunk_size,
      TensorListMetadata<depth>* tl,
...
template<typename T, int depth, int r_args_depth, int res_arg_index>
struct TernaryOpScalarFunctorOpt {
  using opmath_t = at::opmath_type<T>;
  template<typename Op> __device__ __forceinline__ void operator() (
      int chunk_size,
      TensorListMetadata<depth>* tl,
