...
#ifdef USE_MACA
  bool enable_conv2d_nhwc = at::maca::get_maca_enable_conv2d_nhwc();
  if (maca_unlikely(enable_conv2d_nhwc) && weight_ndim == 4) {
    return at::MemoryFormat::ChannelsLast;
  }

  bool enable_conv_nhwc_c_1 = at::maca::get_maca_enable_conv_nhwc_c_1();
  if (maca_unlikely(enable_conv_nhwc_c_1) && weight_ndim == 4 && input.size(1)==1 && weight.size(1)==1) {
    return at::MemoryFormat::ChannelsLast;
  }
#endif
